...
Node* BST::deleteNode(Node *currNode, int value)
{
    ...
    else
    {
        ...
        {
            std::cout << "Node[" << currNode->key << "] has no child" << std::endl;
            delete currNode;
            return NULL;
        }
        ...
        {
            std::cout << "Node[" << currNode->key << "] has only the right child Node[" << currNode->right->key << "]" << std::endl;
        ...
        {
            std::cout << "Node[" << currNode->key << "] has only the left child Node[" << currNode->left->key << "]" << std::endl;
        ...
        {
            std::cout << "Node[" << currNode->key << "] has both the left[" << currNode->left->key << "] and right[" << currNode->right->key << "] child."  << std::endl;
        //Replace with Minimum from right subtree
            Node *minRight = getMinValueNode(currNode->right);
            currNode->key = minRight->key;
            currNode->right = deleteNode(currNode->right, minRight->key);
        }
